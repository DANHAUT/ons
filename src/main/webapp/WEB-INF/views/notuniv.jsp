            ...
            <div id="tabsForms">
                ...
                <div id="tab-display">
                    ...
                    <div id="availableList" style="margin-bottom:10px;"><!-- debut de Ligne -->
                        <div class="style1_titre_deco"><h3><font style="text-transform: none;"><spring:message code="foreignStd.listForeignStdTitle1"/>, <spring:message code="foreignStd.notuniv"/>
                        </font></h3>
                        </div>
                    </div>
