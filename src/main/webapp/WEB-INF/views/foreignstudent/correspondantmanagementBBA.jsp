		...
		<div class="conteneursousparagraphe2">
			<table id="tan" >
				...
				<c:if test="${isErasmus == 'Y'}">
					...
					<tr class="odd">
						<td colspan="2"><b><span class="gamay">Please insert Hannah SZTUMPF (hannah.sztumpf@edhec.edu ) as contact for the Nice campus and Marion DENGLOS (marion.denglos@edhec.edu) as contact for the Lille campus</span></b></td>
					</tr>
				</c:if>
			</table>
		</div>
