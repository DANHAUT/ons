...
<head>
	<title>EDHEC Summer Course</title>
		...
		<div id='primary_nav'>
			<div id='primary_left'>
				<div id='primary_right'>		
					<ul>
						<li class='left active'><a href='loginSummer' title='<spring:message code="foreignStd.connect"/>'><img width="16px" height="16px" src="<c:url value="/img/default_thumb.png" />" /><spring:message code="foreignStd.connect"/> as Summer University</a></li>
						<li class="left " style="float:right;"><a href="<c:url value="./summer?locale=fr"/>"><img width="25" height="15" src="<c:url value="/img/FR.png" />" alt="France" id="FLG_FR" class="FLG_around"/></a></li>
						<li class="left " style="float:right;"><a href="<c:url value="./summer?locale=en"/>"><img width="25" height="15" src="<c:url value="/img/EN.png" />" alt="English" id="FLG_EN" class="FLG_around"/></a></li>
					</ul>
				</div>
			</div>
		</div>
	<div id="main-body">
		...
		<div id="tabsForms">
			<div id="en-tete">
			    <ul>
			    	<li id="actif">
			    		<span><spring:message code="foreignStd.helptitleSummer"/></span>
			    	</li>
			    </ul>
...
<div id="availableList" style="margin-bottom:10px;"><!-- debut de Ligne -->
	<div class="style1_titre_deco"><h3><spring:message code="foreignStd.helpconnectSummer"/></h3>
	</div>
</div>
