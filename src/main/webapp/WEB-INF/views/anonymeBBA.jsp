		...
		<div id='primary_nav'>
			<div id='primary_left'>
				<div id='primary_right'>		
					<ul>
						<li class='left active'><a href='loginBBA' title='<spring:message code="foreignStd.connect"/>'><img width="16px" height="16px" src="<c:url value="/img/default_thumb.png" />" /><spring:message code="foreignStd.connect"/> BBA</a></li>
