		...
		<div id='primary_nav'>
			<div id='primary_left'>
				<div id='primary_right'>		
					<ul>
						<li class='left active'><a href='loginBBA?open=Y' title='<spring:message code="foreignStd.connect"/>'><img width="16px" height="16px" src="<c:url value="/img/default_thumb.png" />" /><spring:message code="foreignStd.connect"/> BBA</a></li>
						<li class="left " style="float:right;"><a href="<c:url value="./bba?locale=fr"/>"><img width="25" height="15" src="<c:url value="/img/FR.png" />" alt="France" id="FLG_FR" class="FLG_around"/></a></li>
						<li class="left " style="float:right;"><a href="<c:url value="./bba?locale=en"/>"><img width="25" height="15" src="<c:url value="/img/EN.png" />" alt="English" id="FLG_EN" class="FLG_around"/></a></li>
					</ul>
				</div>
			</div>
		</div>
